...
public class Cidades {
 ...
 /*   public void gravarCidadesBD(){
        String[] ufs = getEstados();
        ArrayList<String> cidades;

        for (int i = 0; i < ufs.length; i++) {
            cidades = getCidadesByUF(i);

            for (String cidade : cidades) {
                try {
                    TB_Cidade newCidade = new TB_Cidade(ufs[i], cidade);
                    Login.dbm.gravaCidade(newCidade);
    ...
    public static List<String> getEstadosList(){
        return Arrays.asList(UF);
    }

    public static ArrayList<String> getCidadesByUF(int UF) {
        UF --;
        if (UF == 0)
            return new ArrayList<String>(Arrays.asList(AC));
        else if (UF == 1)
            return new ArrayList<String>(Arrays.asList(AL));
        else if (UF == 2)
            return new ArrayList<String>(Arrays.asList(AM));
        else if (UF == 3)
            return new ArrayList<String>(Arrays.asList(AP));
        else if (UF == 4)
            return new ArrayList<String>(Arrays.asList(BA));
    //        return new ArrayList<String>(Arrays.asList(concat(BA, BA6)));
        else if (UF == 5)
            return new ArrayList<String>(Arrays.asList(CE));
        else if (UF == 6)
            return new ArrayList<String>(Arrays.asList(DF));
        else if (UF == 7)
            return new ArrayList<String>(Arrays.asList(ES));
        else if (UF == 8)
            return new ArrayList<String>(Arrays.asList(GO));
        else if (UF == 9)
            return new ArrayList<String>(Arrays.asList(MA));
        else if (UF == 10)
            return new ArrayList<String>(Arrays.asList(MG));
        else if (UF == 11)
            return new ArrayList<String>(Arrays.asList(MS));
        else if (UF == 12)
            return new ArrayList<String>(Arrays.asList(MT));
        else if (UF == 13)
            return new ArrayList<String>(Arrays.asList(PA));
        else if (UF == 14)
            return new ArrayList<String>(Arrays.asList(PB));
        else if (UF == 15)
            return new ArrayList<String>(Arrays.asList(PE));
        else if (UF == 16)
            return new ArrayList<String>(Arrays.asList(PI));
        else if (UF == 17)
            return new ArrayList<String>(Arrays.asList(PR));
        else if (UF == 18)
            return new ArrayList<String>(Arrays.asList(RJ));
        else if (UF == 19)
            return new ArrayList<String>(Arrays.asList(RN));
        else if (UF == 20)
            return new ArrayList<String>(Arrays.asList(RO));
        else if (UF == 21)
            return new ArrayList<String>(Arrays.asList(RR));
        else if (UF == 22)
            return new ArrayList<String>(Arrays.asList(RS));
        else if (UF == 23)
            return new ArrayList<String>(Arrays.asList(SC));
        else if (UF == 24)
            return new ArrayList<String>(Arrays.asList(SE));
        else if (UF == 25)
    ...
    public static int getPosEstado(String val) {
        int res = 0;

        for (int i = 0; i < UF.length; i++){
            if (UFS[i].toString().contentEquals(val.toString())) {
                res = i;
                break;
            }
        }
    ...
    public static int getPosCidade(int posUF, String val) {
        int res = 0;

        ArrayList<String> lista = getCidadesByUF(posUF);
        String[] cids = new String[lista.size()];
        cids = lista.toArray(cids);

        for (int i = 0; i < cids.length; i++){
            if (cids[i].toString().contentEquals(val.toString())) {
                res = i;
                break;
            }
        }
    ...
    private static String[] UF = {"Estados", "Acre","Alagoas","Amazonas","Amapá","Bahia",
            "Ceará","Distrito Federal","Espírito Santo","Goiás","Maranhão","Minas Gerais",
            "Mato Grosso do Sul","Mato Grosso","Pará","Paraíba","Pernambuco","Piauí",
            "Paraná","Rio de Janeiro","Rio Grande do Norte","Rondônia","Roraima",
            "Rio Grande do Sul","Santa Catarina","Sergipe","São Paulo","Tocantins"};

    public static String[] UFS = {"Estados", "AC","AL","AM","AP","BA","CE","DF","ES","GO","MA","MG",
    ...
    private static String[] AC =
            {
                    ...
                    //"Manoel Urbano",
                    //"Marechal Thaumaturgo",                    "Placido de Castro",                    "Porto Acre",                    "Porto Walter",
                    "Rio Branco"//,                    "Rodrigues Alves",                    "Santa Rosa",                    "Sena Madureira",
                    //"Senador Guiomard",                    "Tarauaca",                    "Xapuri"
            };
    private static String[] AL =
            {
                    "Cidades",
                    //"Agua Branca",                    "Alazao",                    "Alecrim",                    "Anadia",                    "Anel",
                    //"Anum Novo",
                    //"Anum Velho",                    "Arapiraca",                    "Atalaia",                    "Baixa da Onca",                    "Baixa do Capim",
                    //"Balsamo",                    "Bananeiras",                    "Barra de Santo Antonio",                    "Barra de Sao Miguel",
                    //"Barra do Bonifacio",                    "Barra Grande",                    "Batalha",                    "Batingas",
                    //"Belem",                    "Belo Monte",                    "Boa Sorte",                    "Boa Vista",                    "Boca da Mata",
                    //"Bom Jardim",                    "Bonifacio",                    "Branquinha",                    "Cacimbinhas",
                    //"Cajarana",                    "Cajueiro",                    "Caldeiroes de Cima",                    "Camadanta",
                    //"Campestre",                    "Campo Alegre",                    "Campo Grande",                    "Canaa",
                    //"Canafistula",                    "Canapi",                    "Canastra",                    "Cangandu",                    "Capela",
                    //"Carneiros",                    "Carrasco",                    "Cha Preta",                    "Coite do Noia",
                    //"Colonia Leopoldina",                    "Coqueiro Seco",                    "Coruripe",                    "Coruripe da Cal",
                    //"Craibas",                    "Delmiro Gouveia",                    "Dois Riachos",                    "Entremontes",
                    //"Estrela de Alagoas",                    "Feira Grande",                    "Feliz Deserto",                    "Fernao Velho",
                    //"Flexeiras",                    "Floriano Peixoto",                    "Gaspar",                    "Girau do Ponciano",
                    //"Ibateguara",                    "Igaci",                    "Igreja Nova",                    "Inhapi",
                    //"Jacare dos Homens",                    "Jacuipe",                    "Japaratinga",                    "Jaramataia",
                    //"Jenipapo",                    "Joaquim Gomes",                    "Jundia",                    "Junqueiro",                    "Lagoa da Areia",
                    //"Lagoa da Canoa",                    "Lagoa da Pedra",                    "Lagoa Dantas",                    "Lagoa do Caldeirao",
                    //"Lagoa do Canto",                    "Lagoa do Exu",                    "Lagoa do Rancho",                    "Lajes do Caldeirao",
                    //"Laranjal",                    "Limoeiro de Anadia",
                     "Maceio"//,                    "Major Isidoro",
                    //"Mar Vermelho",                    "Maragogi",                    "Maravilha",                    "Marechal Deodoro",
                    //"Maribondo",                    "Massaranduba",                    "Mata Grande",                    "Matriz de Camaragibe",
                    //"Messias",                      "Minador do Negrao",                    "Monteiropolis",                    "Moreira",
                    //"Munguba",                    "Murici",                    "Novo Lino",                    "Olho D Agua Grande",
                    //"Olho D'agua Das Flores",                    "Olho D'agua De Cima",                    "Olho D'agua Do Casado",                    "Olho D'agua Dos Dandanhas",
                    //"Olivenca",                    "Ouro Branco",                    "Palestina",                    "Palmeira de Fora",
                    //"Palmeira dos Indios",                    "Pao de Acucar",                    "Pariconha",                    "Paripueira",
                    //"Passo de Camaragibe",                    "Pau D'arco",                    "Pau Ferro",                    "Paulo Jacinto",
                    //"Penedo",                    "Piacabucu",                    "Pilar",                    "Pindoba",                    "Piranhas",
                    //"Pocao",                    "Poco da Pedra",                    "Poco das Trincheiras",                    "Porto Calvo",
                    //"Porto de Pedras",                    "Porto Real do Colegio",                    "Poxim",                    "Quebrangulo",
                    //"Riacho do Sertao",                    "Riacho Fundo de Cima",                    "Rio Largo",                    "Rocha Cavalcante",
                    //"Roteiro",                    "Santa Efigenia",                    "Santa Luzia do Norte",                    "Santana do Ipanema",
                    //"Santana do Mundau",                    "Santo Antonio",                    "Sao Bras",                    "Sao Jose da Laje",
                    //"Sao Jose da Tapera",                    "Sao Luis do Quitunde",                    "Sao Miguel dos Campos",                    "Sao Miguel dos Milagres",
                    //"Sao Sebastiao",                    "Sapucaia",                    "Satuba",                    "Senador Rui Palmeira",
                    //"Serra da Mandioca",                    "Serra do Sao Jose",                    "Taboleiro do Pinto",                    "Taboquinha",
                    //"Tanque D'arca",                    "Taquarana",                    "Tatuamunha",                    "Teotonio Vilela",
                    //"Traipu",                    "Uniao dos Palmares",                    "Usina Camacari",                    "Vicosa",
                    //"Vila Aparecida",                    "Vila Sao Francisco"
            };
    private static String[] AM =
            {
                    "Cidades",
                    //"Alvaraes",                    "Amatari",                    "Amatura",                    "Anama",                    "Anori",                    "Apui",
                    //"Ariau",                    "Atalaia do Norte",                    "Augusto Montenegro",                    "Autazes",                    "Axinim",
                    //"Badajos",                    "Balbina",                    "Barcelos",                    "Barreirinha",                    "Benjamin Constant",
                    //"Beruri",                    "Boa Vista do Ramos",                    "Boca do Acre",                    "Borba",                    "Caapiranga",
                    //"Cameta",                    "Canuma",                    "Canutama",                    "Carauari",                    "Careiro",                    "Careiro da Varzea",
                    //"Carvoeiro",                    "Coari",                    "Codajas",                    "Cucui",                    "Eirunepe",                    "Envira",
                    //"Floriano Peixoto",                    "Fonte Boa",                    "Freguesia do Andira",                    "Guajara",                    "Humaita",
                    //"Iauarete",                    "Icana",                    "Ipixuna",                    "Iranduba",                    "Itacoatiara",                    "Itamarati",
                    //"Itapiranga",                    "Japura",                    "Jurua",                    "Jutai",                    "Labrea",                    "Lago Preto",
                    //"Manacapuru",                    "Manaquiri",
                    "Manaus"//,                    "Manicore",                    "Maraa",                    "Massauari",                    "Maues",                    "Mocambo",
                    //"Moura",                    "Murutinga",                    "Nhamunda",                    "Nova Olinda do Norte",                    "Novo Airao",
                    //"Novo Aripuana",                    "Osorio da Fonseca",                    "Parintins",                    "Pauini",                    "Pedras",
                    //"Presidente Figueiredo",                    "Repartimento",                    "Rio Preto da Eva",                    "Santa Isabel do Rio Negro",
                    //"Santa Rita",                    "Santo Antonio do Ica",                    "Sao Felipe",                    "Sao Gabriel da Cachoeira",
                    //"Sao Paulo de Olivenca",                    "Sao Sebastiao do Uatuma",                    "Silves",                    "Tabatinga",                    "Tapaua",
                    //"Tefe",                    "Tonantins",                    "Uarini",                    "Urucara",                    "Urucurituba",                    "Vila Pitinga"
            };
    private static String[] AP =
            {
                    "Cidades",
                    //"Abacate da Pedreira",                    "Agua Branca do Amapari",                    "Amapa",                    "Amapari",                    "Ambe",
                    //"Aporema",                    "Ariri",                    "Bailique",                    "Boca do Jari",                    "Calcoene",                    "Cantanzal",
                    //"Carmo",                    "Clevelandia do Norte",                    "Corre Agua",                    "Cunani",                    "Curiau",
                    //"Cutias",                    "Fazendinha",                    "Ferreira Gomes",                    "Fortaleza",                    "Gaivota",                    "Gurupora",
                    //"Igarape do Lago",                    "Ilha de Santana",                    "Inaja",                    "Itaubal",                    "Laranjal do Jari",
                    //"Livramento do Pacui",                    "Lourenco",
                    "Macapa"//,                    "Mazagao",                    "Mazagao Velho",                    "Oiapoque",                    "Paredao",                    "Porto Grande",
                    //"Pracuuba",                    "Santa Luzia do Pacui",                    "Santa Maria",                    "Santana",                    "Sao Joaquim do Pacui",
                    //"Sao Sebastiao do Livramento",                    "Sao Tome",                    "Serra do Navio",                    "Sucuriju",                    "Tartarugalzinho",
                    //"Vila Velha",                    "Vitoria do Jari"
            };
